...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   [_HOMEROW_MACOS] = LAYOUT_split_3x6_3(
        //|-----------------------------------------------------|        |------------------------------------------------------|
            _______, _______, _______, _______, _______, _______,         _______, _______, _______, _______, _______, _______,
            _______, LCTL_KA, _______, _______, LGUI_KF, _______,         _______, RGUI_KJ, _______, _______, RCTL_SC, _______,
            KC_LPAD, _______, _______, _______, _______, _______,         _______, _______, _______, _______, _______, KC_MCTL,
        //|-----------------------------------------------------|        |------------------------------------------------------|
   ...
   [_LOWER] = LAYOUT_split_3x6_3(
        //|-----------------------------------------------------|        |-----------------------------------------------------|
            ...
            _______, _______, _______, _______, _______, XXXXXXX,         KC_LEFT, KC_DOWN,   KC_UP, KC_RIGHT, RFS_BWR, PRT_SCR,
            _______, DBG_EVA,   KC_F7,   KC_F8,   KC_F9, XXXXXXX,         KC_HOME, KC_PGDN, KC_PGUP,   KC_END, SEL_COL, KC_RSFT,
        //|-----------------------------------------------------|        |-----------------------------------------------------|
